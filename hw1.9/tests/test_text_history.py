...
class TextHistoryOptimizeTestCase(TestCase):
    def test_optimize_two_insert(self):
        ...
        h.insert('bc', 2)
        h.optimize_actions()
        self.assertEqual(len(h.get_actions()), 1)
        ins_act = InsertAction(0, "afbc", 0, 2)
        self.assertEqual(h.get_actions()[0].__dict__, ins_act.__dict__)
    ...
    def test_optimize_two_delete(self):
        ...
        self.assertEqual(h.get_actions()[0].__dict__, del_act.__dict__)
    ...
    def test_optimize_two_replace(self):
        ...
        self.assertEqual(h.get_actions()[0].__dict__, repl_act.__dict__)
